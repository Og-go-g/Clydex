...
const CHAT_MODES: Record<ChatMode, ModeConfig> = {
  ...
  copytrade: {
    welcome: "Copy mode — discover top traders on 01 Exchange and mirror their strategies.\n\n",
    footer: "\n\nWho do you want to copy?",
    placeholder: "Find a trader to copy...",
    prompts: [
      { label: "Top traders", example: "top traders this week" },
      { label: "Leaderboard", example: "show leaderboard" },
      { label: "Best BTC trader", example: "best BTC trader to copy" },
      { label: "Copy a trader", example: "copy top trader on BTC" },
...
function CollapsibleCard({
  ...
  if (collapsed) {
    return (
      <div className="my-0.5 flex w-full max-w-3xl items-center gap-2 rounded-lg border border-white/5 bg-background/50 px-3 py-1">
...
function ChatContent({ chatId, chatMode, onModeChange }: { chatId: string; chatMode: ChatMode; onModeChange: (mode: ChatMode) => void }) {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem+1px)] flex-col">
        ...
        <div className="mx-auto flex max-w-2xl flex-col gap-2.5">
          ...
          {showWelcome && (
            <div className="flex justify-start">
              <div className="max-w-[80%] rounded-xl border border-border bg-card/50 backdrop-blur-sm px-3 py-2 text-sm leading-snug text-foreground">
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm px-3 py-2">
                <Spinner />
              </div>
            </div>
          )}
      ...
      {/* Input */}
      <div className="border-t border-border/40 bg-[#0a0a0a]/[0.08] backdrop-blur-sm p-4">
